...
// AI feature strings
$string['aisettings'] = 'AI assistance settings';
$string['aienabled'] = 'Enable AI assistance';
$string['aienabledhelp'] = 'Enable AI-powered hints and explanations for students';
$string['geminiapikey'] = 'Gemini API Key';
$string['geminiapikeydesc'] = 'API key for Google Gemini to power AI features';
$string['aihint'] = 'Get AI hint';
$string['aiexplain'] = 'Explain error with AI';
$string['aiimprove'] = 'Get AI improvement suggestions';
$string['aihintlimit'] = 'Hint limit per student';
$string['aihintlimithelp'] = 'Maximum number of AI hints each student can request';
$string['aiexplainlimit'] = 'Error explanation limit per student';
$string['aiexplainlimithelp'] = 'Maximum number of AI error explanations each student can request';
$string['aiimprovelimit'] = 'Code improvement limit per student';
$string['aiimprovelimithelp'] = 'Maximum number of AI code improvement suggestions each student can request';
$string['airesponse'] = 'AI Response';
$string['aiexplanation'] = 'AI Explanation';
$string['aihintresponse'] = 'AI Hint';
$string['aisuggestions'] = 'AI Improvement Suggestions';
$string['ailimitexceeded'] = 'You have reached your limit for this AI feature';
$string['aiimproveonlyaccepted'] = 'Improvement suggestions are only available for correct submissions';
$string['aiclose'] = 'Close';
$string['airemaining'] = 'Remaining: {$a}';
$string['ainohint'] = 'AI could not generate a hint for this submission';
$string['noerrortoexplain'] = 'No error found to explain';
$string['invalidaction'] = 'Invalid AI action requested';
$string['emptyresponse'] = 'The AI service returned an empty response';
$string['apikeymissing'] = 'Gemini API key is not configured';
$string['apirequesterror'] = 'Error connecting to the Gemini API: {$a}';
$string['apiresponseerror'] = 'The Gemini API returned an error: {$a}';
$string['aidisclaimer'] = 'This response was generated by AI and may contain errors.';
